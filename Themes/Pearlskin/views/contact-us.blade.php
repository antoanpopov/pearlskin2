...
@section('content')
    ...
    <div class="container content">
        ...
        {!! Form::open(['route' => ['admin.pearlskin.procedure.store'], 'method' => 'post','class' => 'col-lg-6 col-sm-12 col-xs-12']) !!}
        <div class="col-sm-12">
        ...
        <div class="col-sm-12"><button type="submit"
                                       class="btn">{{ trans('pearlskin::common.buttons.send_request') }}</button></div>
