...
class CreatePearlskinPriceListCatsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pearlskin__price_list_cats', function (Blueprint $table) {
            $table->engine = 'InnoDB';
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('pearlskin__price_list_cats');
    }
}
