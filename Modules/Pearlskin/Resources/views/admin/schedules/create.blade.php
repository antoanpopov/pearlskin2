...
@section('content-header')
    <h1>
        {{ trans('pearlskin::schedules.title.create schedule') }}
    </h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('dashboard.index') }}"><i
                        class="fa fa-dashboard"></i> {{ trans('core::core.breadcrumb.home') }}</a></li>
        <li>
            <a href="{{ route('admin.pearlskin.schedule.index') }}">{{ trans('pearlskin::schedules.title.schedules') }}</a>
        </li>
        <li class="active">{{ trans('pearlskin::schedules.title.create schedule') }}</li>
    </ol>
@stop
            ...
            <div class="nav-tabs-custom">
                ...
                <div class="box-footer">
                    ...
                    <a class="btn btn-danger pull-right btn-flat"
                       href="{{ route('admin.pearlskin.schedule.index')}}"><i
