...
@section('content-header')
    <h1>
        {{ trans('pearlskin::manipulations.title.create manipulation') }}
    </h1>
    <ol class="breadcrumb">
        ...
        <li class="active">{{ trans('pearlskin::manipulations.title.create manipulation') }}</li>
    </ol>
@stop

@section('styles')
    {!! Theme::script('js/vendor/ckeditor/ckeditor.js') !!}
    {!! Theme::script('bootstrap-datetimepicker.min.js') !!}
@stop
