...
return [
   ...
   */
    'admin-assets' => [
        ...
        'bootstrap-datetimepicker.min.css' => ['module' => 'pearlskin:vendor/eonasdan-bootstrap-datetimepicker/build/css/bootstrap-datetimepicker.min.css'],
        // Javascript
        ...
        'moment-with-locales.min.js' => ['module' => 'pearlskin:vendor/moment/min/moment-with-locales.min.js'],
        'bootstrap-datetimepicker.min.js' => ['module' => 'pearlskin:vendor/eonasdan-bootstrap-datetimepicker/build/js/bootstrap-datetimepicker.min.js'],
    ],
